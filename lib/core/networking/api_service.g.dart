...
class _ApiService implements ApiService {
  ...
  Future<List<GetAttendanceHistoryResponse>> getAttendanceHistory(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<GetAttendanceHistoryResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            GetAttendanceHistoryResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<CompareImagesResponseBody> compareImages(
      CompareImagesRequestBody compareImagesRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(compareImagesRequestBody.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CompareImagesResponseBody>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
